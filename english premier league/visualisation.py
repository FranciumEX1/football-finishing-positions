...
visualTablePlaces = Bar(
    y=fullTable["Team"],
    x=[position for position in finalTable["BestToWorst"] if position != 0],
    orientation="h",
...
fullVisual = Figure(data=[visualTablePlaces, visualPosition], layout=layout)
